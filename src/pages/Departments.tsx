...
const Departments = () => {
  ...
  const [departmentsData, setDepartmentsData] = useState([
    { id: 1, name: 'Cardiology', description: 'Deals with heart disorders', head: 'Dr. John Smith', employees: 15 },
    { id: 2, name: 'Neurology', description: 'Deals with nervous system disorders', head: 'Dr. Alice Johnson', employees: 12 },
    { id: 3, name: 'Orthopedics', description: 'Deals with bone and joint issues', head: 'Dr. Michael Brown', employees: 10 },
    { id: 4, name: 'Pediatrics', description: 'Deals with children\'s health', head: 'Dr. Emily Davis', employees: 18 },
  ]);

  const filteredDepartments = activeTab === 'all'
    ? departmentsData
    : departmentsData.filter(department => department.name.toLowerCase().includes(activeTab.toLowerCase()));
  ...
  const handleDeleteDepartment = (id: number) => {
    ...
    setDepartmentsData(departmentsData.filter(department => department.id !== id));
  };
  ...
  return (
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-white">Departments</h1>
          <p className="text-gray-600 dark:text-gray-300">Manage hospital departments</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-6">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700">
          <nav className="flex overflow-x-auto">
            {['All', 'Cardiology', 'Neurology', 'Orthopedics', 'Pediatrics'].map((tab) => (
              <button
                key={tab}
